      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            />
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-primary rounded-full opacity-20" />
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-primary rounded-full opacity-10" />
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-secondary-foreground/80 mt-4 leading-relaxed">
                Saffron has been treasured for centuries in Ayurveda and traditional medicine. 
                Discover the incredible health benefits of this precious spice.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {benefits.map((benefit, index) => (
                <motion.div
                  ...
                  className="flex items-start gap-3 p-4 bg-secondary-foreground/5 rounded-xl"
                >

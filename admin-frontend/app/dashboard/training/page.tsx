...
const TrainingManagement = () => {
  const [trainings, setTrainings] = useState([
    {
      ...
      description:
        "Learn the fundamentals of saffron farming from soil preparation to harvesting",
    ...
    },
    {
      ...
      description:
        "Master the art of identifying premium saffron quality and grading standards",
    ...
    },
    {
      ...
      description:
        "Complete guide to post-harvest processing and premium packaging techniques",
      category: "Processing",
      level: "Advanced",
      duration: "8 hours",
      price: 6000,
    ...
    },
    {
      ...
      description:
        "Learn to build and scale your saffron business with effective marketing strategies",
      category: "Business",
      level: "Intermediate",
      duration: "5 hours",
      price: 3500,
  ...
  const filteredTrainings = trainings.filter((training) => {
    ...
    const matchesStatus =
      selectedStatus === "All" || training.status === selectedStatus;
  ...
  const handleDelete = (id: number) => {
    ...
    if (training && training.currentEnrollments > 0) {
  ...
  const toggleFeatured = (id: number) => {
    setTrainings((trainings) =>
      trainings.map((training) =>
        training.id === id
          ? { ...training, featured: !training.featured }
          : training
      )
    );
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-admin-600">
              Create and manage saffron training courses
            </p>
          </div>
          <button
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    <div className="font-semibold text-admin-800">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {training.topics.slice(0, 3).map((topic, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-1 bg-admin-100 text-admin-600 text-xs rounded"
                      >
                        {topic}
                      </span>
                    ))}

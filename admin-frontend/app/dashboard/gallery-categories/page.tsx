...
import { galleryCategoriesApi } from "@/lib/api";
...
const GalleryCategoriesManagement = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingCategory) {
        await galleryCategoriesApi.update(editingCategory._id, formData);
        toast.success("Category updated successfully!");
      } else {
        await galleryCategoriesApi.create(formData);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await galleryCategoriesApi.delete(id);
  ...
  if (loading) {
    return (
      <DashboardLayout title="Gallery Categories">
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-admin-600">Organize your gallery images</p>
          </div>
          <button
...
export default GalleryCategoriesManagement;
